					...
					<div class="w-4/5 lg:w-3/4">
						<div class="w-full border-2 border-dotted border-teal-dark p-4">
							<div class="flex justify-between">
								<div class="w-1/5">
									<img alt="fictiv values" src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/fictiv-values.png">
								</div>
								<div class="w-4/5">
									<div>
	...
	<div class="container">
		<div class="flex flex-wrap justify-center lg:justify-start">
			...
			<div class="w-11/12 lg:w-1/2">
				...
				<div class="mb-4">
					<p class="text-blue-light text-18 uppercase font-fat">meet our team</p>	
					
				</div>
				<div class="mb-4">
					<p class="text-blue-dark text-36 font-fat">"I love building features that enable more efficient workflows and processes. I get excited about making parts of people’s lives easier and automated."</p>
				</div>
				<div class="mb-4">
					<p>
				...
				<div class="mb-8">
					<a href="" class="btn btn-secondary">read the blog post</a>
				</div>
		...
		<div class="flex justify-center">
			<div class="w-11/12 lg:w-3/5 ">
				...
				<div class="flex items-center flex-wrap justify-center">
					<div class="mx-6 mb-4">
						<img width="80" alt="Investor Logo G2VP" src="<?php echo get_template_directory_uri(); ?>/assets/images/logos/investor-g2vp.png">
					</div>
					<div class="mx-6 mb-4">
						<img width="60" alt="Investor Logo G2VP" src="<?php echo get_template_directory_uri(); ?>/assets/images/logos/investor-mitsui-co.jpg">
					</div>
					<div class="mx-6 mb-4">
						<img width="90" alt="Investor Logo G2VP" src="<?php echo get_template_directory_uri(); ?>/assets/images/logos/investor-sinovation-ventures.png">
					</div>
					<div class="mx-6 mb-4">
						<img width="90" alt="Investor Logo G2VP" src="<?php echo get_template_directory_uri(); ?>/assets/images/logos/investor-accel.png">
					</div>
					<div class="mx-6 mb-4">
						<img width="70" alt="Investor Logo G2VP" src="<?php echo get_template_directory_uri(); ?>/assets/images/logos/investor-intel.png">
					</div>
					<div class="mx-6 mb-4">
						<img width="100" alt="Investor Logo G2VP" src="<?php echo get_template_directory_uri(); ?>/assets/images/logos/investor-fj-labs.png">
					</div>
					<div class="mx-6 mb-4">
						<img width="100" alt="Investor Logo G2VP" src="<?php echo get_template_directory_uri(); ?>/assets/images/logos/investor-bill-gates.png">
					</div>
					<div class="mx-6 mb-4">
						<img width="100" alt="Investor Logo G2VP" src="<?php echo get_template_directory_uri(); ?>/assets/images/logos/investor-tandon-group.png">
					</div>
					<div class="mx-6 mb-4">
						<img width="80" alt="Investor Logo G2VP" src="<?php echo get_template_directory_uri(); ?>/assets/images/logos/investor-start.png">
					</div>
					<div class="mx-6 mb-4">
						<img width="80" alt="Investor Logo G2VP" src="<?php echo get_template_directory_uri(); ?>/assets/images/logos/investor-svangel.png">
					</div>
				</div>
			</div>
		</div>
